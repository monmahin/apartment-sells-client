import initialFirebase from "../Pages/LoginPage/Firebase/firebase.init";
...
const useFirebase = () => {
    ...
    useEffect(() => {
        fetch(`https://desolate-lowlands-20122.herokuapp.com/users/${user.email}`)
            .then(res => res.json())
    ...
    const saveUser = (email, displayName,method ) => {
        ...
        // console.log(user)
        fetch('https://desolate-lowlands-20122.herokuapp.com/users', {
            method: method,
            headers: {
